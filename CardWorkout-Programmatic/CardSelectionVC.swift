...
//
//  Created by Danut Popa on 13.04.2024.
//

import UIKit

class CardSectionVC: UIViewController {
  ...
  // this function is called when the view controller is loaded into memory
  ...
  func configureCardImageView() {
    ...
    cardImageView.translatesAutoresizingMaskIntoConstraints = false // use auto layout on this object
